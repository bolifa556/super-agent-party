      ...
      'bodyPlaceholder': `Enter the body in JSON Schema format. For example:
{
    ...
    "required": ["name", "age"]
        ...
        'changeUserDataPath': 'Change data path',
        'customDataRoot': 'Data root path',
        'customSkillsRoot': 'Skills path',
        'selectFolder': 'Select folder',
        'resetToDefaultPath': 'Use default path',
        'currentDataRoot': 'Current data root',
        'currentSkillsRoot': 'Current skills root',
        'pathChangeNotice': 'Path changes take effect after restart. Existing data will be copied to the new location on restart.',
