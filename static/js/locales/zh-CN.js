      ...
      'bodyPlaceholder': `请输入请求体，使用JSON Schema格式。例如：
{
    ...
    "required": ["name", "age"]
        ...
        'changeUserDataPath': '修改数据路径',
        'customDataRoot': '数据根目录',
        'customSkillsRoot': 'Skills 目录',
        'selectFolder': '选择文件夹',
        'resetToDefaultPath': '恢复默认路径',
        'currentDataRoot': '当前数据根目录',
        'currentSkillsRoot': '当前 Skills 目录',
        'pathChangeNotice': '修改后需重启生效，重启时会把现有数据复制到新位置。',
        'openLogfile': '打开日志文件夹',
